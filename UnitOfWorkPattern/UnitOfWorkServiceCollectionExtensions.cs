...
namespace UnitOfWorkPattern
{
    ...
    public static class UnitOfWorkServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Registers the unit of work type given context as a service in the <see cref="IServiceCollection"/>.
        /// </summary>
        /// <typeparam name="TUnitOfWorkTypes">The type of the db context.</typeparam>
        /// <param name="services">The <see cref="IServiceCollection"/> to add services to.</param>
        /// <returns>The same service collection so that multiple calls can be chained.</returns>
        /// <remarks>
        /// This method only support one db context, if been called more than once, will throw exception.
        /// </remarks>
        public static IServiceCollection AddUnitOfWorkBuilder<TUnitOfWorkTypes>(this IServiceCollection services)
        {
